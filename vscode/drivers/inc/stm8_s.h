...
//-------------LCD_API(lcd_api.h)--------------------
// TODO Винести дефайни які унікаліні для файл в h файли окремі
...
#define LCD_CMD_EN_LOW 0x08   // Команда: Підсвітка=1, EN=0, RS=0
#define LCD_DATA_EN_HIGH 0x0D // Дані:    Підсвітка=1, EN=1, RS=1
#define LCD_DATA_EN_LOW 0x09  // Дані:    Підсвітка=1, EN=0, RS=1

// Базові команди дисплея HD44780
#define LCD_CMD_FUNCTION_SET_8BIT 0x30 // Режим 8 біт (використовується при старті)
#define LCD_CMD_4BIT_MODE 0x20         // Переведення в 4-бітний режим
#define LCD_CMD_FUNCTION_SET_4BIT 0x28 // Налаштування: 4-біт, 2 рядки, шрифт 5x8
#define LCD_CMD_DISPLAY_OFF 0x08       // Вимкнути дисплей і курсор
#define LCD_CMD_CLEAR 0x01             // Очистити екран
#define LCD_CMD_ENTRY_MODE 0x06        // Напрямок руху курсора (ліворуч -> праворуч)
#define LCD_CMD_DISPLAY_ON 0x0C        // Увімкнути дисплей (курсор і миготіння вимкнені)
